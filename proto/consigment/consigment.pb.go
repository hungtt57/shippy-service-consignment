...
func (x *Consignment) Reset() {
	*x = Consignment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_consigment_consigment_proto_msgTypes[0]
...
func (*Consignment) Descriptor() ([]byte, []int) {
	return file_proto_consigment_consigment_proto_rawDescGZIP(), []int{0}
}
...
func (x *Container) Reset() {
	*x = Container{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_consigment_consigment_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Container) Descriptor() ([]byte, []int) {
	return file_proto_consigment_consigment_proto_rawDescGZIP(), []int{1}
}
...
func (x *Response) Reset() {
	*x = Response{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_consigment_consigment_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return file_proto_consigment_consigment_proto_rawDescGZIP(), []int{2}
}
...
var File_proto_consigment_consigment_proto protoreflect.FileDescriptor

var file_proto_consigment_consigment_proto_rawDesc = []byte{
	0x0a, 0x21, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6f, 0x6e, 0x73, 0x69, 0x67, 0x6d, 0x65,
	0x6e, 0x74, 0x2f, 0x63, 0x6f, 0x6e, 0x73, 0x69, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72,
...
var (
	file_proto_consigment_consigment_proto_rawDescOnce sync.Once
	file_proto_consigment_consigment_proto_rawDescData = file_proto_consigment_consigment_proto_rawDesc
)

func file_proto_consigment_consigment_proto_rawDescGZIP() []byte {
	file_proto_consigment_consigment_proto_rawDescOnce.Do(func() {
		file_proto_consigment_consigment_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_consigment_consigment_proto_rawDescData)
	})
	return file_proto_consigment_consigment_proto_rawDescData
}

var file_proto_consigment_consigment_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_consigment_consigment_proto_goTypes = []interface{}{
	(*Consignment)(nil), // 0: consignment.Consignment
	(*Container)(nil),   // 1: consignment.Container
	(*Response)(nil),    // 2: consignment.Response
}
var file_proto_consigment_consigment_proto_depIdxs = []int32{
...
func init() { file_proto_consigment_consigment_proto_init() }
func file_proto_consigment_consigment_proto_init() {
	if File_proto_consigment_consigment_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_consigment_consigment_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_consigment_consigment_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_consigment_consigment_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_consigment_consigment_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_consigment_consigment_proto_goTypes,
		DependencyIndexes: file_proto_consigment_consigment_proto_depIdxs,
		MessageInfos:      file_proto_consigment_consigment_proto_msgTypes,
	}.Build()
	File_proto_consigment_consigment_proto = out.File
	file_proto_consigment_consigment_proto_rawDesc = nil
	file_proto_consigment_consigment_proto_goTypes = nil
	file_proto_consigment_consigment_proto_depIdxs = nil
}
